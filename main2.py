...
from g2 import Data_Loader1
train_loader=Data_Loader1(train_imgs,train_masks,batch_size)
val_loader=Data_Loader1(val_imgs,val_masks,batch_size)
...
from models import m_unet_33_2
...
def save_checkpoint(state, filename="m_unet_33_2.pth.tar"):
...
def main():
    model = m_unet_33_2().to(device=DEVICE,dtype=torch.float)
    loss_fn1 =IoULoss()
...
plt.tight_layout()
plt.show()
fig.savefig('m_unet_33_2.png', bbox_inches='tight')   