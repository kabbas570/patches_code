...
def save_checkpoint(state, filename="train4_4Reduced.pth.tar"):
...
#            torchvision.utils.save_image(img1[0,1,:,:],str(batch_idx)+'img.png')
...
plt.tight_layout()
plt.show()
fig.savefig('train4_4Reduced.png', bbox_inches='tight')