...
from models import m_unet_33_3
...
def save_checkpoint(state, filename="m_unet_33_3.pth.tar"):
...
def main():
    model = m_unet_33_3().to(device=DEVICE,dtype=torch.float)
    loss_fn1 =IoULoss()
...
plt.tight_layout()
plt.show()
fig.savefig('m_unet_33_3.png', bbox_inches='tight')   
